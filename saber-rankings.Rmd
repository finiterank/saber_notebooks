...
write(paste(1:nrow(top.publicos), top.publicos$municipio, "(", top.publicos$departamento, ") Puntaje Matemática:", round(top.publicos$promedio.mat,2), "Puntaje Lenguaje:", round(top.publicos$promedio.leng,2)), file="output_files/top.publicos.txt", sep="\n")
```
